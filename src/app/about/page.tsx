        ...
        <div className="container relative z-20">
          <div className="text  flex items-start">
            ...
            <div>
              ...
              <p className="text-[18px] sm:text-[25px] lg:text-[31px] text-[#BFAF9D] md:pl-[90px] mr-[15px]">
                ...
                purposeful investing, responsible stewardship, and a belief in
                the power of aligned partnerships. Today, the group is led by a
                cross-generational team, actively shaping future initiatives and
                leading investments across sectors.
              </p>
            </div>
          </div>
          <div className="-ml-[100px]">
            <Image
              ...
              className=" object-contain globeImage"
            />
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr,332px] items-center ">
            <div className="">
              ...
              {dnaItems.map((item) => (
                <div
                  key={item.title}
                  className="md:pl-[124px] pb-[20px] md:pb-[38px] border-b-[1.53px] border-[#A58F77]">
        ...
        <div className="container pt-[30px] custompl border-l-[1.8px] border-[#A58F77] ">
          <div className="pb-[40px] md:pb-[90px]">
            <div className="pl-0 md:pl-[47px] md:grid grid-cols-[1fr,320px] pt-[50px] md:pt-0 md:-mt-[20px]">
              <div className="relative group aboutGroup">
                <Image
                  src={capital}
                  alt="about"
                  style={{ width: "auto", height: "auto" }}
            ...
            <div className="mt-[25px] md:mt-[45px] md:pl-[111px] md:pb-[46px] md:border-b-[1.8px] border-[#A58F77]">
              ...
              <p className="text-[#bfaf9d] font-light text-[16px] md:text-[18.5px] leading-[2] max-w-[910px]">
                ...
                high-growth, financial ventures in the UK, UAE, South Asia, and
                beyond. As a global, cross-generational and multi-asset
                investment firm, the Hayaat Group continues to enrich its
                experience, broaden its scope, and stay focused on long-term
                value creation. With each investment, we build on our foundation
                of trust, ambition, and impact, ensuring that we prosper with
      ...
      <div className="bg-[#3F3B33] relative ">
        ...
        <div className="container border-l-[1.8px] border-[#A58F77]">
          <div className="pb-[80px] lg:pb-[150px] xl:pb-[200px] pt-[67px]">
            <h2 className="text-[40px] md:text-[53px] lg:text-[72px] text-center text-[#BFAF9D] mb-[50px] md:mb-[150px] xl:mb-[200px]">
              Meet Our Team
            </h2>
