  ...
  return (
    <>
            ...
            <div className="flex items-center justify-between mb-12">
              <div className="flex flex-col items-center gap-[3px]">
                <div className="w-7 h-7 border border-white flex items-center justify-center">
                  <span className="font-antic text-white text-lg leading-none">
                    H
                  </span>
                </div>
                <span className="text-white text-[6px] font-light tracking-[0.22em] uppercase">
                  HAYAAT GROUP
                </span>
              </div>
              <button
      ...
      <header className="pt-[15px] sm:pt-[30px] lg:pt-[50px] absolute top-0 left-0 right-0 z-[99]">
            ...
            <div className="image">
              <Link href="/" className="inline-block">
                <Image
                  ...
                  width={132}
                  height={130}
                  className="h-[80px] lg:h-auto object-contain"
                />
              </Link>
            </div>
        ...
        {/* Overlay */}
        <div
          className={`fixed  left-0 right-0 bottom-0 h-[100%] bg-[#3E3E3E] z-[99] pt-[30px] md:pt-[50px] xl:pt-[70px] px-[0] md:px-[40px] xl:px-[88px] transition-all duration-500 ease-in-out  ${
            open ? "top-0" : "-top-[200%]"
          }`}
        >
          <div className="container mx-auto">
