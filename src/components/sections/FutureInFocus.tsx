  ...
  return (
    <div className="bg-[#3F3B33] -mt-[1px]">
      <div className="container  border-[#A58F77] border-l-[1.8px] relative">
        ...
        <div className="pb-[120px] pl-[120px] pt-[60px] md:pt-[80px]">
          <h2 className="text-[#BFAF9D] text-[37px] sm:text-[42px] md:text-[60px] xl:text-[72px] leading-tight mb-[30px] sm:mb-[40px] mt-0 font-[400]">
            The Future in Focus
          </h2>
          <p className="Inter text-white text-[15px] lg:text-[18px] font-[300] leading-[2] xl:leading-[3] max-w-[1100px] mb-[30px] sm:mb-[50px] xl:mb-[50px] opacity-85">
            ...
            principal investor across thoughtfully diversified areas, balancing
            active capital deployment in strategic ventures with disciplined
            stewardship of long-term assets. These focus areas reflect our
            progressive commitment to value creation, and evolving vision for
            the future.
          </p>
